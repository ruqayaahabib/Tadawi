...
## User Stories
1. As a patient, I want to sign in and sign out to access the website
2. As a patient or guest, I want to browse hospitals and choose one
3. As a patient, I want to view the departments within the hospital
4. As a patient, I want to view doctors by department
5. As a patient, I want to book an appointment  and choose the date and time
6. As a patient, I want to view my appointments and be able to reschedule or cancel it

7. As a doctor, I want to view assigned appointment
8. As a doctor, I want to update appointment status from pending to confirmed, declined or completed

9. As an admin, I want to manage hospitals, departments and doctors
